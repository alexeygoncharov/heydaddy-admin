            ...
            <div className="scroll">
              ...
              >
                <Nav vertical className="list-unstyled">
                  ...
                  menuItems.map(item => {
                    return (
                        (userPermissions.filter(item2 => item2.name === item.permissions).length ===1 ||
                            (item.subPermissions && item.subPermissions.map(subPermission => {
                              return  userPermissions.filter(i => i.name === subPermission)
                            }).filter(koas => koas.length !== 0).length !== 0) ||
                        ...
                        >
                          {/*{console.log(item.subPermissions && item.subPermissions.map(subPermission => {*/}
                          {/*  return  userPermissions.filter(i => i.name === subPermission)*/}
                          {/*}))}*/}
                          ...
                          return (
                              ...
                              >
                                {sub.subs && sub.subs.length > 0 ? (
                                    ...
                                    (sub.subPermissions && sub.subPermissions.map(subPermission => {
                                      return  userPermissions.filter(i => i.name === subPermission)
                                      // eslint-disable-next-line no-mixed-operators
                                    }).filter(koas => koas.length !== 0).length !== 0 || item.permissions === true) &&
                                    <Fragment>
                                            ...
                                            return (
                                                ...
                                                >
                                                  {thirdSub.newWindow ? (
                                                      ...
                                                      (userPermissions.filter(item => item.name === thirdSub.permissions).length ===1 || thirdSub.permissions === true ||
                                                          (thirdSub.permissions2 !== undefined && userPermissions.filter(item => item.name === thirdSub.permissions2).length ===1)
                                                      ) &&
                                    ...
                                    (userPermissions.filter(item => item.name === sub.permissions).length ===1 || sub.permissions === true || (sub.permissions2 !== undefined
                                        && userPermissions.filter(item => item.name === sub.permissions2).length ===1)) &&
                                    <NavLink to={sub.to}>
