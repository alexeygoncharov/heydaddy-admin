                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-sm-12 blog-detail">
                                <img src={`/assets/img/balloon.jpg`} className="img-fluid" alt=""/>
                        ...
                        <div className="row section-b-space blog-advance">
                            <div className="col-lg-6">
                                <img src={`${process.env.PUBLIC_URL}/assets/images/blog/1.jpg`} className="img-fluid" alt="sdsf"/>
                            </div>
                            <div className="col-lg-6">
                                <img src={`${process.env.PUBLIC_URL}/assets/images/blog/2.jpg`} className="img-fluid" alt="fdsfs"/>
                            </div>
                            <div className="col-lg-6">
                                <ul>
                        ...
                        <div className="row section-b-space">
                            <div className="col-sm-12">
                                <ul className="comment-section">
                                    <li>
                                        <div className="media">
                                            <img src={`/assets/img/balloon.jpg`} alt="Generic placeholder " />
                                ...
                                <form className="theme-form">
                                    <div className="form-row">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <textarea className="form-control" placeholder="Write Your Comment" id="exampleFormControlTextarea1" rows="6"/>
                                        </div>
                                        <div className="col-md-12">
