...
export default class CreateTag extends Component {
    ...
    createTag = async (e)=> {
        ...
        const {name } = this.state;
            ...
            let response = await ApiCall.post(Url.STORE_TAG, {
                name: name,
            }, await config());
                ...
                <Row>
                    <Colxx xxs="12">
                        <div className="text-zero top-right-button-container">
                            <Link to='/app/tags/view'><Button size='lg' color={'secondary'}><IntlMessages id={"menu.cancel"} /></Button></Link>
                        </div>
                    ...
                    <Col xxs="10">
                        ...
                        <Card>
                            ...
                            <CardBody>
                                ...
                                <Form className="dashboard-quick-post" onSubmit={this.createTag}>
                                    <FormGroup row>
                                        <Label sm="3">
